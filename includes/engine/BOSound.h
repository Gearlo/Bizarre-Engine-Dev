...
class M_ENGINE_EXPORT BOSound : public BObject3d
{
public:

	// constructor / destructor
	BOSound(BSoundRef * soundRef);
	virtual ~BOSound(void);

	// copy constructor
	BOSound(const BOSound & sound);

private:

	// sound ref
	BSoundRef * m_soundRef;
...
public:
	...
	// type
	int getType(void){ return U_OBJECT3D_SOUND; }

	// sound ref
	void setSoundRef(BSoundRef * soundRef);
	inline BSoundRef * getSoundRef(void){ return m_soundRef; }
