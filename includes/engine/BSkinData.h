...
// Skin Point
class M_ENGINE_EXPORT BSkinPoint
{
public:
...
// Skin Data
class M_ENGINE_EXPORT BSkinData
{
public:
...
public:
	...
	BSkinPoint * allocPoints(unsigned int size);
	inline unsigned int getPointsNumber(void){ return m_pointsNumber; }
	inline BSkinPoint * getPoint(unsigned int id){ return &m_points[id]; }
};
