...
#define ULOG(severity, USERMESSAGE) { ULog::m_stringstream.str(std::string("")); ULog::m_stringstream<<USERMESSAGE; ULog::m_string=ULog::m_stringstream.str(); ULog::log(severity, __FUNCTION__, __FILE__, __LINE__); }

// common helpers
#define ULOG_ERROR(USERMESSAGE) ULOG(3, USERMESSAGE)
#define ULOG_WARNING(USERMESSAGE) ULOG(4, USERMESSAGE)
#define ULOG_INFO(USERMESSAGE) ULOG(6, USERMESSAGE)
#define ULOG_DEBUG(USERMESSAGE) ULOG(7, USERMESSAGE)


class M_ENGINE_EXPORT ULog
{
private:
