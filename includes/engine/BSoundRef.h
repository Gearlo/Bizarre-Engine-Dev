...
// Sound ref
class M_ENGINE_EXPORT BSoundRef : public BDataRef
{
private:
...
public:
	...
	BSoundRef(unsigned int bufferId, const char * filename);
	~BSoundRef(void);
	...
	// get new
	static BSoundRef * getNew(unsigned int bufferId, const char * filename);
...
public:
	...
	// type
	int getType(void){ return U_REF_SOUND; }
