...
class M_ENGINE_EXPORT BOLight : public BObject3d
{
public:
...
public:
	...
	// type
	int getType(void){ return U_OBJECT3D_LIGHT; }
	...
	inline void setColor(const BVector3f & color){ m_color = color; }
	inline float getIntensity(void){ return m_intensity; }
	inline BVector3f getColor(void) const { return m_color; }
	inline BVector3f getFinalColor(void) const { return m_color * m_intensity; }
