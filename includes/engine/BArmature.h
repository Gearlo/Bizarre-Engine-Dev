...
class M_ENGINE_EXPORT BArmature
{
private:
...
public:
	...
	BOBone * addNewBone(void);
	BOBone * getBoneByName(const char * name);
	inline unsigned int	getBonesNumber(void){ return m_bonesNumber; }
	inline BOBone *	getBone(unsigned int bId){ return m_bones[bId]; }
