...
// Data load function
class M_CORE_EXPORT BDataLoadFunction
{
public:

	BDataLoadFunction(bool (* functionPtr)(const char * filename, void * data));
	~BDataLoadFunction(void);
...
// Data loader
class M_CORE_EXPORT BDataLoader
{
private:

	// loaders
	vector <BDataLoadFunction *> m_loaders;
