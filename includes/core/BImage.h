...
public:
	...
	void create(U_TYPES dataType, unsigned int width, unsigned int height, unsigned int components);
	...
	U_TYPES getDataType(void){ return m_dataType; }
