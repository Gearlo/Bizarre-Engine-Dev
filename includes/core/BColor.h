...
public:
	...
	BColor(unsigned char newR, unsigned char newG, unsigned char newB, unsigned char newA):	
		r(newR), 
		g(newG), 
		b(newB),
		a(newA)
...
public:
	...
	inline BColor operator + (const BColor & color) const
	{	
	...
	inline BColor operator + (const int value) const
	{	
	...
	inline BColor operator * (const float value) const
	{	
		int R = CLAMP((int)(r * value), 0, 255);
		int G = CLAMP((int)(g * value), 0, 255);
		int B = CLAMP((int)(b * value), 0, 255);
	...
	inline bool operator == (const BColor & color) const
	{
