...
class M_CORE_EXPORT BInputContext
{
public:
    
	virtual ~BInputContext(void){}
    ...
    // touch events
    virtual void beginTouch(int touchID, BVector2f touchPoint) = 0;
    virtual void updateTouch(int touchID, BVector2f touchPoint) = 0;
    virtual void endTouch(int touchID, BVector2f touchPoint) = 0;
    virtual void cancelTouch(int touchID, BVector2f touchPoint) = 0;
	
    virtual BVector2f getTouchPosition(int touchID) = 0;
    virtual BVector2f getLastTouchPosition(int touchID) = 0;
