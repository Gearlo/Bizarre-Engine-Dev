...
class BInput : public BInputContext
{
public :
...
private :
    ...
    {
        M_TOUCH_PHASE phase;
        BVector2f touchPoint;
        BVector2f lastTouchPoint;
...
public:
    ...
    void beginTouch(int touchID, BVector2f touchPoint);
    void updateTouch(int touchID, BVector2f touchPoint);
    void endTouch(int touchID, BVector2f touchPoint);
    void cancelTouch(int touchID, BVector2f touchPoint);
    
    BVector2f getTouchPosition(int touchID);
    BVector2f getLastTouchPosition(int touchID);
