...
void BImage::create(U_TYPES dataType, unsigned int width, unsigned int height, unsigned int components)
{
	SAFE_FREE(m_data);
...
void BImage::writePixel(unsigned int x, unsigned int y, void * color)
{
	unsigned int c;
...
void BImage::readPixel(unsigned int x, unsigned int y, void * color)
{
	unsigned int c;
	unsigned int pixelId = ((m_width * m_components) * y) + (x * m_components);
